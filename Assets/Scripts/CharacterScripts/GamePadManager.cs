    ...
    public GamePadManager(gamepad controller)
    {
        switch (controller)
        {
            ...
            case gamepad.one:
                ...
                m_Attack = "B_1";
                m_jumpButton = "A_1";
                m_MoveAxisX = "L_XAxis_1";
                m_MoveAxisY = "L_YAxis_1";
                m_AimAxisX = "R_XAxis_1";
                m_AimAxisY = "R_YAxis_1";
                m_activate = "Y_1";
                break;
            case gamepad.two:
                m_LeftEquipKey = "X_2";
                m_Attack = "B_2";
                m_jumpButton = "A_2";
                m_MoveAxisX = "L_XAxis_2";
                m_MoveAxisY = "L_YAxis_2";
                m_AimAxisX = "R_XAxis_2";
                m_AimAxisY = "R_YAxis_2";
                m_activate = "Y_2";
                break;
                */
        }
